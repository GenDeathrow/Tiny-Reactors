package com.arclighttw.tinyreactors.client.util;
...
public class SmallFontRenderer implements IResourceManagerReloadListener
{
    ...
    public SmallFontRenderer(GameSettings par1GameSettings, ResourceLocation par2ResourceLocation, TextureManager par3TextureManager, boolean par4)
    {
        ...
        if (this.renderEngine == null)
        		System.err.println("renderEngine is null");
            ...
            else
            {
                ...
                */
                ...
                if (this.strikethroughStyle)
                {
                    ...
                    bb.pos((double)posX, (double)(posY + (FONT_HEIGHT / 2)), 0.0D).endVertex();
                    bb.pos((double)(posX + f1), (double)(posY + (FONT_HEIGHT / 2)), 0.0D).endVertex();
                    bb.pos((double)(posX + f1), (double)(posY + (FONT_HEIGHT / 2) - 1.0F), 0.0D).endVertex();
                    bb.pos((double)posX, (double)(posY + (FONT_HEIGHT / 2) - 1.0F), 0.0D).endVertex();
                    tessellator.draw();
                ...
                if (this.underlineStyle)
                {
                    ...
                    bb.pos((double)(posX + (float)l), (double)(posY + FONT_HEIGHT), 0.0D).endVertex();
                    bb.pos((double)(posX + f1), (double)(posY + FONT_HEIGHT), 0.0D).endVertex();
                    bb.pos((double)(posX + f1), (double)(posY + FONT_HEIGHT - 1.0F), 0.0D).endVertex();
                    bb.pos((double)(posX + (float)l), (double)(posY + FONT_HEIGHT - 1.0F), 0.0D).endVertex();
                    tessellator.draw();
                    GL11.glEnable(GL11.GL_TEXTURE_2D);
                }
    ...
    public int getCharWidth (char par1)
    {
        ...
        else
        {
            ...
            {
                i = 69;
                System.err.println("dont send bad chat characters to my font renderer!");
            }
